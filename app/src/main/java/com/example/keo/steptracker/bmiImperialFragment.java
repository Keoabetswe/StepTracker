...
public class bmiImperialFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View v =  inflater.inflate(R.layout.fragment_bmi_imperial, container, false);

        btnCalc = v.findViewById(R.id.btnImperialCalculate);
        btnClear = v.findViewById(R.id.btnImperialClear);

        etWeight = v.findViewById(R.id.etImperialWeight);
        etHeight = v.findViewById(R.id.etImperialHeight);

        tvResult = v.findViewById(R.id.tvImperialResult);
        tvCategory = v.findViewById(R.id.tvImperialCategory);

        ivInfo = v.findViewById(R.id.ivImperialBmiInfo);
